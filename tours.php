              ...
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="./assets/images/popular-1.jpg" width="740" height="518" loading="lazy"
                      alt="Mumbai, India" class="img-cover">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <div class="card-wrapper">
                    <div class="card-price">From Rs.3000</div>
                  ...
                  <h3 class="card-title">
                    <a href="#">Explore the Elephanta Caves, Gateway of India, Siddhi Vinayak Temple and Marine Drive.</a>
                  </h3>

                  <address class="card-location">Mumbai, India</address>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="./assets/images/popular-2.jpg" width="740" height="518" loading="lazy"
                      alt="Bengaluru, India" class="img-cover">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <div class="card-wrapper">
                    <div class="card-price">From Rs.4000</div>
                  ...
                  <h3 class="card-title">
                    <a href="#">Enjoy Tipu Sultan’s Summer Palace, Nandi Hills, Cubbon Park and National Gallery Of Modern Art.</a>
                  </h3>

                  <address class="card-location">Bengaluru, India</address>
            ...
            <li>
              <div class="popular-card">
                ...
                <figure class="card-banner">
                  <a href="#">
                    <img src="./assets/images/popular-3.jpg" width="740" height="518" loading="lazy"
                      alt="Chennai, India" class="img-cover">
                  </a>
                ...
                <div class="card-content">
                  ...
                  <div class="card-wrapper">
                    <div class="card-price">From Rs.5000</div>
                  ...
                  <h3 class="card-title">
                    <a href="#">Visit Marina Beach, Shri Ashtalakshmi Temple, Santhome Cathedral Basilica and Guindy National Park</a>
                  </h3>

                  <address class="card-location">Chennai, India</address>
